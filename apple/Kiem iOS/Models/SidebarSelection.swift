...
///
/// Mirrors `apple/Kiem/Models/SidebarSelection.swift` in the macOS target. Kept
/// as a separate file here (not shared with the AppKit bound) so the two
/// targets stay independently shipable and neither destabilizes the other.
...
/// single tag/project (a project is a reserved `proj/<slug>` tag). Always has
/// a value — "All Notes" is `.allNotes`, not the absence of a selection.
